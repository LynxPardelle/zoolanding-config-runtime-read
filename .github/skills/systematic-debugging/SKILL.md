...
description: 'Repo-local root-cause debugging workflow for Zoolanding Lambda issues. Use before fixing handler validation bugs, contract mismatches, helper failures, or unexpected SAM behavior.'
user-invocable: true
---
