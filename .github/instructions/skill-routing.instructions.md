...
- For shared workspace customization audits or cross-repo rollout summaries, use the canonical hub prompts under [`zoolandingpage/.github/prompts`](https://github.com/LynxPardelle/zoolandingpage/tree/main/.github/prompts).
