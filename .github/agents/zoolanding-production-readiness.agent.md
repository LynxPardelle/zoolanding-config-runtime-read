...
description: 'Use when reviewing this runtime-read Lambda for deploy readiness, missing validation, missing contract evidence, config drift, or release blockers. Focus on findings first, not implementation.'
