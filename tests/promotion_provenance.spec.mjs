...
const repository = 'LynxPardelle/zoolanding-config-runtime-read';
...
test('associated-PR lookup uses API 2026, retries empty responses, and accepts null merge SHA', async () => {
  let calls = 0;
